...
const ReturnCard: React.FC<OrderCardProps> = ({ order, onDownloadInvoice, onCancelOrder }) => {
...
const resolvedAtDate = order.resolvedAt ? new Date(order.resolvedAt) : null;
