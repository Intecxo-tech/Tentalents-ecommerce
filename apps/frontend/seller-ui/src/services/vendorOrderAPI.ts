...
export const getVendorOrders = async (): Promise<VendorOrder[]> => {
  ...
  const response = await axios.get('https://orderservice.zeabur.app/api/orders/vendor/orders', {
    headers: {
...
export async function updateDispatchStatus(
  ...
  const res = await fetch(`https://orderservice.zeabur.app/api/orders/vendor/orders/${orderId}/dispatch`, {
    method: 'PATCH',
    headers: {
